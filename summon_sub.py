...
parser = argparse.ArgumentParser(description="Start a basic HTTP server")
parser.add_argument("-p", "--port", type=int, default=3030, help="Port to listen on")
args = parser.parse_args()

port = args.port if args.port else int(os.environ.get("PORT", 3030))
GLO_VARS = globals()
LOC_VARS = locals()
